...
<body onload="onClickTab('xemcaygiao.jsp')">
	<div class="container">
		<img src="SPKT.jpg" width="100%">
		<div class="row">
			<div class="col-md-9">
				<a href="nguoigiaomoi.jsp">Trang chủ</a>
			</div>
			<div class="col-md-3">
		...
		<div class="row content">
			<div class="col-sm-3 sidenav">
				<nav class="nav">
				<ul class="nav tabs">
					<li onclick="onClickTab('xemcaygiao.jsp')" class="active"><a
...
<footer
	style="background-color: rgb(83, 163, 163); height: 90px; padding-top: 25px;padding-left:40%; ;color: #fff">
