...
<body onload="onClickTab('xemcay.jsp')">
	<div class="container"
		...
		<div class="row">
			<div class="col-xs-12">
				<a href="trangchu6.jsp" style="font-size: 15px">Trang chủ</a> <a
					href="trangchu6.jsp" class="btn btn-primary btn-sm pull-right"
					type="button" id="btnShowModal">Thoát</a>
			</div>
		</div>
		<br> <br>
		<div class="row content">
			<div class="col-sm-3 sidenav">
				...
				<ul class="nav tabs">
					<li onclick="onClickTab('xemcay.jsp')" class="active"><a
						href="#" data-toggle="tab">Xem Minh Chứng</a></li>
					<li onclick="onClickTab('quydinhthem.jsp')" class=""><a
						href="#" data-toggle="tab">Thêm Minh Chứng</a></li>
					<li onclick="onClickTab('quydinhsua.jsp')" class=""><a
						href="#" data-toggle="tab">Sửa Minh Chứng</a></li>
