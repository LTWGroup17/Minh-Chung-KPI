    ...
    <div class="row">
      ...
      <img src="SPKT.jpg" width="100%">
        ...
        <div style="text-align: center; margin-top: 100px;" >
           <button class="btn btn-primary" style="margin: 0 auto;" type="button" id="btnShowModal">Đăng Nhập Tài Khoản</button>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style = "padding: 10px">
                ...
                <div class="form-group">
                    <form>
                      <input type="radio" name="gender"  value="giangvien" onclick = "nmc()"> Giảng Viên
                      <input type="radio" name="gender"  value="admin" onclick = "adm()"> Admin
                      <input type="radio" name="gender"  value="quydinh" onclick = "qdmc()"> Người Quy Định
                      <input type="radio" name="gender"  value="giaoviec" onclick = "gmc()"> Người Giao
                      <input type="radio" name="gender"  value="giaoviec" onclick = "ktmc()"> Người Kiểm Tra
                    </form>                  
                </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Password" name = "pass" id="inputPass" placeholder="Login Password" class="form-control">
                  </div>
