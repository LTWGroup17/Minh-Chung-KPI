...
(function ($) {
    $.fn.EasyTree = function (options) {
        ...
        this.each(function () {
            ...
            // addable
            if (options.addable) {
                $(easyTree).find('.easy-tree-toolbar').append('<div class="create"><button class="btn btn-default btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span></button></div> ');
            ...
            // editable
            if (options.editable) {
                $(easyTree).find('.easy-tree-toolbar').append('<div class="edit"><button class="btn btn-default btn-sm btn-info disabled"><span class="glyphicon glyphicon-wrench"></span></button></div> ');
            ...
            // deletable
            if (options.deletable) {
                $(easyTree).find('.easy-tree-toolbar').append('<div class="remove"><button class="btn btn-default btn-sm btn-warning disabled"><span class="glyphicon glyphicon-fire"></span></button></div> ');
