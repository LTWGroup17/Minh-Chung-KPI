...
<body onload="onClickTab('nguoinhapdanhsach.jsp')">
    ...
    <div class="row content">
        <div class="col-sm-3 sidenav">
         <nav class="nav-sidebar">
            <ul class="nav tabs">
              <li onclick="onClickTab('nguoinhapdanhsach.jsp')" ><a href="#" data-toggle="tab">Danh Sách Minh Chứng</a></li>              
              <li onclick="onClickTab('nguoinhapnhap.jsp')"><a href="#" data-toggle="tab">Nhập Minh Chứng</a></li>    
